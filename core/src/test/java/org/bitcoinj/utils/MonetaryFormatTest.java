...
public class MonetaryFormatTest {
    ...
    public void standardCodes() throws Exception {
        assertEquals("BCASH 0.00", MonetaryFormat.BTC.format(Coin.ZERO).toString());
        assertEquals("mBCASH 0.00", MonetaryFormat.MBTC.format(Coin.ZERO).toString());
        assertEquals("µBCASH 0", MonetaryFormat.UBTC.format(Coin.ZERO).toString());
    }

    @Test
    public void customCode() throws Exception {
        assertEquals("dBCASH 0", MonetaryFormat.UBTC.code(1, "dBCASH").shift(1).format(Coin.ZERO).toString());
    }
    ...
    public void noCode() throws Exception {
        ...
        assertEquals("dBCASH 0", MonetaryFormat.UBTC.noCode().code(1, "dBCASH").shift(1).format(Coin.ZERO).toString());
    }

    @Test
    public void codeOrientation() throws Exception {
        assertEquals("BCASH 0.00", MonetaryFormat.BTC.prefixCode().format(Coin.ZERO).toString());
        assertEquals("0.00 BCASH", MonetaryFormat.BTC.postfixCode().format(Coin.ZERO).toString());
    }

    @Test
    public void codeSeparator() throws Exception {
        assertEquals("BCASH@0.00", MonetaryFormat.BTC.codeSeparator('@').format(Coin.ZERO).toString());
    }
